...
class Body:
    ...
    def __init__(self):
        ...
        self.resources['shoulder_left'].move = lambda deg,*args,**kwargs: self.resources['shoulder_left'].set((180-deg)%181, *args, **kwargs)
        # Initial status
        ...
        self.resources['elbow_left'].move = lambda deg,*args,**kwargs: self.resources['elbow_left'].set((180-deg)%181,*args,**kwargs)
        ...
        WEBCAM
        """
        self.resources['webcam'] = WebcamStreamer('cvlc --no-audio v4l2:///dev/video0:width=800:height=600 --v4l2-fps 10 --sout "#transcode{vcodec=MJPG,vb=1600}:standard{access=httpux=mpjpeg,dst=:18223/}" --sout-http-mime="multipart/x-mixed-replace;boundary=--7b3cc56e5f51db803f790dad720ed50a"')
